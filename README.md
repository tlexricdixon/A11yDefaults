...
- Support for anchors whose `href` is generated by MVC's built-in Anchor Tag Helper.
- Focus-ring classes for keyboard-visible interactive states.
- Safer `target="_blank"` links with configurable visible or screen-reader-only hints.
